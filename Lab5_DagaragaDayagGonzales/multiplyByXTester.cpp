...
/*
 * Contents of multiplyByX are generated via compiling this
 * cpp file alongside the appropriate s file 
 * In this case, the s file would be multiplyByX.s, of which
 * is intended to be generated via the multiplyByX.cpp
 */
...
int main()
{
    ...
    // - print out the expected result of the multiplyByX function with the given multiplier
    cout << endl << "Expected Result: " << endl;
    for(int i = 0; i < array->getSize(); i++){
        cout << array->getElement(i)*n << " ";
    }
    cout << endl;

    // - this time, multiply it using the external function and the multiplier that was given.
